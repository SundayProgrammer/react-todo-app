...
class EditTask extends Component {
  constructor(props) {
    ...
    this.state = {
      task: this.props.task ? this.props.task : this.emptyTask(),
  ...
  componentDidMount() {
    this.prevTask = JSON.parse(
      JSON.stringify(this.props.task ? this.props.task : this.emptyTask())
    );
  }
  ...
  handleSubmit = event => {
    ...
    if (
      JSON.stringify(this.prevTask) !== JSON.stringify(this.state.task) &&
